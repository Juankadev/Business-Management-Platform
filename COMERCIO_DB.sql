...
CREATE TABLE PRODUCTOS(
  ...
  --IDASOCIADOS VARCHAR(12) NOT NULL FOREIGN KEY REFERENCES PROVEEDORES_X_PRODUCTO(ID),
  PRECIO MONEY NULL, /*anular, se calcula con porcentaje*/
...
GO
CREATE TABLE VENTAS(
  NUM_VENTA INT NOT NULL PRIMARY KEY IDENTITY(1000,1),
...
CREATE TABLE DETALLE_VENTA(
  ...
  DETALLE_VENTA INT NOT NULL FOREIGN KEY REFERENCES VENTAS(NUM_VENTA),
...
CREATE TABLE COMPRAS(
  NUM_COMPRA INT NOT NULL PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE DETALLE_COMPRA(
  --NUM_DETALLE INT NOT NULL PRIMARY KEY,
  DETALLE_COMPRA INT NOT NULL FOREIGN KEY REFERENCES COMPRAS(NUM_COMPRA),
  COD_PRODUCTO VARCHAR(10) NOT NULL FOREIGN KEY REFERENCES PRODUCTOS(CODIGO),
  CANTIDAD INT NOT NULL,
...
CREATE TABLE PROVEEDORES_X_PRODUCTO(
  ...
  CUIT_PROVEEDOR VARCHAR(12) NOT NULL FOREIGN KEY REFERENCES PROVEEDORES(CUIT),
...
--  PRIMARY KEY (NUM_COMPRA, CODIGO_PRODUCTO)
--)
--GO
