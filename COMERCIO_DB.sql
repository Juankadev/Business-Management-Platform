...
Create Table PROVEEDORES(
  CUIT VARCHAR(10) NOT NULL PRIMARY KEY,
  APELLIDO VARCHAR(50) NULL,
  NOMBRE VARCHAR(50) NOT NULL,
  TELEFONO VARCHAR(15) NOT NULL,
  MAIL VARCHAR(50) NOT NULL,
...
CREATE TABLE PRODUCTOS(
  ...
  CUITPROVEEDOR VARCHAR(10) NOT NULL FOREIGN KEY REFERENCES PROVEEDORES(CUIT),
  PRECIO MONEY NOT NULL,
  STOCK_ACTUAL INT NOT NULL,
  STOCK_MINIMO INT NOT NULL,
  PORCENTAJE_GAN INT NOT NULL,
  ESTADO BIT
)
GO
CREATE TABLE VENTAS(
...
CREATE TABLE COMPRAS(
  ...
  COD_PROVEEDOR VARCHAR(10) NOT NULL FOREIGN KEY REFERENCES PROVEEDORES(CUIT),
  COD_PRODUCTO VARCHAR(10) NOT NULL FOREIGN KEY REFERENCES PRODUCTOS(CODIGO),
  CANTIDAD INT NOT NULL,
